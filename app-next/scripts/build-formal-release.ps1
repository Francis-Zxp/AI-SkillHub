...
$LatestPayload = [ordered]@{
  version = $Version
  notes = "AI SkillHub v${Version}: resilient official-update retries, a viewport-safe glass editor, an optically centered logo, cache-first live atlas startup, a single volumetric graph core, and preserved user data."
