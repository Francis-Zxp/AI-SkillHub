...
$LatestPayload = [ordered]@{
  version = $Version
  notes = "AI SkillHub v${Version}: reliable cancellable GitHub imports, safe ZIP symlink handling, a read-only MCP connection inventory, a zero-write Codex plugin doctor, and preserved local user data."
