...
$LatestPayload = [ordered]@{
  version = $Version
  notes = "AI SkillHub v${Version}: sparse Skill-only GitHub imports for very large repositories, signed Release-asset fallback, bounded security scanning, and preserved local user data."
