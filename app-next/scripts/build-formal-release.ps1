...
$LatestPayload = [ordered]@{
  version = $Version
  notes = "AI SkillHub v${Version}: reliable large-source security review, persistent Add Source drafts, cancellable GitHub imports, read-only MCP/Codex diagnostics, and preserved local user data."
