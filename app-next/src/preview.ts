  ...
  return {
    ...
    sources: [
      ...
      },
      {
        ...
        sourceType: "skill",
        health: "warn",
        url: "https://github.com/BehiSecc/VibeSec-Skill.git",
        skillCount: 1,
        mode: "explicit",
        createdAt: "2026-05-01T00:00:00Z",
        categoryId: "security-audit",
        note: "Skill 与脚本安全审计。",
        localPath: "../app-next/data/github_sources/VibeSec-Skill",
        enabled: true,
        tags: ["GitHub", "安全"]
      },
      {
        ...
        note: "产品规划与工程执行工具集。",
        localPath: "../app-next/data/github_sources/gstack",
        enabled: true,
        tags: ["GitHub", "智能体工具"]
      },
      {
    ...
    agentSkillStatuses: [
      {
        ...
        agentId: "claude",
        agentName: "Claude Desktop / Claude Code",
      ...
      },
      {
        ...
        agentId: "codex",
        agentName: "ChatGPT Desktop / OpenAI Codex",
        skillName: "paper-workflow",
        skillFolderName: "paper-workflow",
